...
CREATE TABLE motif_de_frais (
  ...
  libelle varchar(50) NOT NULL
  ,CONSTRAINT motif_de_frais_PK PRIMARY KEY (id_motif)
) ENGINE=InnoDB;
--
...
CREATE TABLE type_util (
  ...
  libelle varchar(50) NOT NULL
  	,CONSTRAINT type_util_PK PRIMARY KEY (id_type_utilisateur)
) ENGINE=InnoDB;
--
...
CREATE TABLE utilisateur (
  ...
  id_type_utilisateur int(11) NOT NULL
	...
	,CONSTRAINT utilisateur_type_util_FK FOREIGN KEY (id_type_utilisateur) REFERENCES type_util(id_type_utilisateur)
) ENGINE=InnoDB;
--
...
(103, "TOM", "TOM", "TOM@TOM.fr", "$2y$10$APocNP6nDR.B52eALimeDu6Pxrm8BOzqPeBypNERgu4kEDdGSkbJO", 1, 3);
-- -----------------------------------------------------------
--
...
CREATE TABLE controleur (
  ...
  Matricule_CONT varchar(50) NOT NULL
  	,CONSTRAINT controleur_PK PRIMARY KEY (id_utilisateur)
	,CONSTRAINT controleur_utilisateur_FK FOREIGN KEY (id_utilisateur) REFERENCES utilisateur(id_utilisateur)
	,CONSTRAINT controleur_type_util0_FK FOREIGN KEY (id_type_utilisateur) REFERENCES type_util(id_type_utilisateur)
) ENGINE=InnoDB;
...
CREATE TABLE club (
  ...
  ,CONSTRAINT club_PK PRIMARY KEY (id_club)
	...
	,CONSTRAINT club_controleur0_FK FOREIGN KEY (id_utilisateur) REFERENCES controleur(id_utilisateur)
) ENGINE=InnoDB;
--
...
CREATE TABLE adherent (
  ...
  id_club int(11) NOT NULL
    ,CONSTRAINT adherent_PK PRIMARY KEY (id_utilisateur)
	,CONSTRAINT adherent_utilisateur_FK FOREIGN KEY (id_utilisateur) REFERENCES utilisateur(id_utilisateur)
	,CONSTRAINT adherent_club0_FK FOREIGN KEY (id_club) REFERENCES club(id_club)
	,CONSTRAINT adherent_type_util1_FK FOREIGN KEY (id_type_utilisateur) REFERENCES type_util(id_type_utilisateur)
) ENGINE=InnoDB;
...
INSERT INTO adherent (id_utilisateur, numero_licence, code_sexe, date_naissance, adresse1, adresse2, adresse3, nom_responsable, prenom_responsable, code_statut, id_club)
VALUES
...
CREATE TABLE administrateur (
  ...
  ,CONSTRAINT administrateur_PK PRIMARY KEY (id_utilisateur)
	...
	,CONSTRAINT administrateur_type_util0_FK FOREIGN KEY (id_type_utilisateur) REFERENCES type_util(id_type_utilisateur)
) ENGINE=InnoDB;
--
...
CREATE TABLE note (
  ...
  ,CONSTRAINT note_PK PRIMARY KEY (id_note)
	,CONSTRAINT note_adherent_FK FOREIGN KEY (id_utilisateur) REFERENCES adherent(id_utilisateur)
) ENGINE=InnoDB;
--
...
CREATE TABLE ligne_de_frais (
  ...
  annee int(11) NOT NULL,
  id_note int(11) NOT NULL
  ,CONSTRAINT ligne_de_frais_PK PRIMARY KEY (id_ligne)
	,CONSTRAINT ligne_de_frais_motif_de_frais_FK FOREIGN KEY (id_motif) REFERENCES motif_de_frais(id_motif)
	,CONSTRAINT ligne_de_frais_periode0_FK FOREIGN KEY (annee) REFERENCES periode(annee)
	,CONSTRAINT ligne_de_frais_note1_FK FOREIGN KEY (id_note) REFERENCES note(id_note)
) ENGINE=InnoDB;
--
