...
<body>
    ...
    <div>
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h1 style="text-align:center">Modifier votre ligne de frais</h1>
                </div>
            </div>
            <div class="row">
    ...
    <div>
        <div class="container">
            <div class="row">
                <div class="col-md-6" style="height: 120px;width: 555px;">
                    <div class="dropdown" style="width: 555px;height: 120px;"><button class="btn btn-primary dropdown-toggle" data-toggle="dropdown" aria-expanded="false" type="button" style="background-color: rgb(247,249,252);color: rgb(80,94,108);width: 180px;margin: 85px;margin-top: 50px;">Statut</button>
                        <div
                            class="dropdown-menu" role="menu"><a class="dropdown-item" role="presentation" href="#">En cours</a><a class="dropdown-item" role="presentation" href="#">Validée</a><a class="dropdown-item" role="presentation" href="#">Contrôlée</a></div>
                </div>
            </div>
            <div class="col-md-6 col-xl-6" style="width: 555px;height: 120px;">
                ...
                </div><input type="text" style="width: 260px;height: 50px;margin: 60px;margin-top: 40px;padding: 10px 40px;background-color: rgb(247,249,252);color: rgb(80,94,108);" placeholder="Total (€)"></div>
        </div>
    </div>
    </div>
    <div>
