...
<?php require_once('include/nav.php'); ?>
    ...
    <div class="row" style="margin-top: 46px;">
        <div class="col-md-4"><button class="btn btn-primary border rounded-0 float-right" type="button" style="width: 230px;margin: 0px;height: 48px;padding: 6px 12px;min-height: 0px;max-height: none;margin-left: 6px;margin-right: 50px;margin-bottom: 9px;">Modifier</button></div>
        <div
